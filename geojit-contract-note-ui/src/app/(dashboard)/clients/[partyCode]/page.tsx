...
import { clientsApi, jobsApi, useSegments } from '@/lib/api'
import type { JobCustomer, EmailEvent, Segment } from '@/types'
import { Loader2 } from 'lucide-react'
import { cn, fmtDate, fmtDateTime } from '@/lib/utils'
import { downloadCsv } from '@/lib/export'
import { toast } from 'sonner'
import Link from 'next/link'
import BounceReportSection from '@/components/bounce-report-section'
...
export default function ClientDetailPage() {
  ...
  const failed = history.filter(h => h.emailStatus === 'FAILED' || h.pdfStatus === 'FAILED' || h.emailStatus === 'SKIPPED').length
  ...
  return (
    <div className="space-y-5 fade-up">
      ...
      <div className="p-6">
        ...
        {/* BOUNCE REPORT TAB */}
        {activeTab === 'bounce' && (
          <BounceReportSection partyCode={partyCode} />
        )}
        ...
        {activeTab === 'dl' && (
          <div className="space-y-3">
            ...
            {loadingTimeline ? (
              ...
              <div className="card p-12 text-center">
                <span className="material-symbols-outlined text-5xl text-slate-200">mail</span>
