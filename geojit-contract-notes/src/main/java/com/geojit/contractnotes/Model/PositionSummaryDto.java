...
/**
 * DTO for Geojit Position Summary (P) tag - Different from Position (P) tag earlier
 * Format: <Unique Id>|P|<Security Description>|<B/S>|<Quantity>|<Gross Rate Per Security>|
 *         <Gross Total(Rs)>|<Gross Brokerage Per Security>|<Brokerage(Total)>|
 *         <Net Rate(Rs)>|<Net Total Amount(Rs)>
 * Expected field count: 11
 */
public class PositionSummaryDto {
    ...
    public PositionSummaryDto() {
    }

    public PositionSummaryDto(String uniqueId, String recordType, String securityDescription,
                              String buySell, String quantity, String grossRatePerSecurity,
                              String grossTotalRs, String grossBrokeragePerSecurity,
                              String brokerageTotal, String netRateRs, String netTotalAmountRs) {
